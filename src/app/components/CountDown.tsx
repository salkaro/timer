...
import { validateNumber } from '../utils/input-validation';
...
const CountDown: React.FC<CountDownProps> = ({ timer, isRunning, theme, reset, removeTimer }) => {
    ...
    return (
        <div className="w-full flex flex-col items-center justify-center gap-4 font-bold text-gray-900">
            {/* Title & Remove */}
            ...
            {/* Set Timer */}
            {!isRunning && (
                <div className='flex flex-row text-3xl sm:text-9xl w-full justify-start'>
                    <input
                        type="text"
                        value={hours}
